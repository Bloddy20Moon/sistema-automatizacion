...
## Summary
- 24 nodes · 20 edges · 6 communities (4 shown, 2 thin omitted)
...
1. `Documento de Definición Técnica y Operativa (V4)` - 5 edges
...
Cohesion: 0.33
Nodes (5): 1. Caso de Negocio: La Crisis del Crecimiento Operativo, 4. Flujo de Resiliencia y Gestión de Excepciones, A. Planteamiento del Problema, B. Solución Propuesta, Documento de Definición Técnica y Operativa (V4)
...
## Knowledge Gaps
- **14 isolated node(s):** `graphify`, `graphify`, `Workflow: graphify`, `A. Planteamiento del Problema`, `B. Solución Propuesta` (+9 more)
