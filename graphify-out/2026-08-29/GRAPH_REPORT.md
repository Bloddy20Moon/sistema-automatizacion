...
## Summary
- 50 nodes · 45 edges · 10 communities (8 shown, 2 thin omitted)
...
- Documento de Definición Técnica y Operativa
- 2. Fases de Implementación
- 3. Estructura de Datos (Diccionario de Datos)
...
4. `Documento de Definición Técnica y Operativa` - 6 edges
5. `2. Fases de Implementación` - 5 edges
6. `2. Fases de Implementación` - 5 edges
7. `3. Estructura de Datos (Diccionario de Datos)` - 5 edges
8. `1. Caso de Negocio: La Crisis del Crecimiento Operativo` - 3 edges
9. `1. Caso de Negocio: La Crisis del Crecimiento Operativo` - 3 edges
10. `graphify` - 2 edges
...
### Community 7 - "Documento de Definición Técnica y Operativa"
Cohesion: 0.29
Nodes (6): 1. Caso de Negocio: La Crisis del Crecimiento Operativo, 4. Flujo de Resiliencia y Gestión de Excepciones, 5. Optimización de Rendimiento y Consumo de APIs, A. Planteamiento del Problema, B. Solución Propuesta, Documento de Definición Técnica y Operativa

### Community 8 - "2. Fases de Implementación"
Cohesion: 0.40
Nodes (5): 2. Fases de Implementación, Fase 1: Estructuración y Fundación de Datos, Fase 2: Automatización de Ingesta y Limpieza de Datos, Fase 3: Interfaces de Visualización (Dashboards), Fase 4: Transición al Ingreso Nativo y Desconexión

### Community 9 - "3. Estructura de Datos (Diccionario de Datos)"
Cohesion: 0.40
...
## Knowledge Gaps
- **34 isolated node(s):** `graphify`, `graphify`, `Workflow: graphify`, `A. Planteamiento del Problema`, `B. Solución Propuesta` (+29 more)
